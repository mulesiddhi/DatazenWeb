        ...
        <div className='cards' id='about' >
            ...
            <div className='cards_Container bg-white'>
                <div className='cards_Wrapper bg-white'>
                  ...
                  <br/>
                  <p className='bg-white'>In response to the ever-increasing importance of data , Datazen  is here   to enhance the understanding, knowledge and experience of analyzing data, taking it step by step, talking to people from around the world and understanding from every perspective and every field.</p>

<br/>

<p className='bg-white'>It is a place that gives students the platform to think out of the box and become as creative as they can get with data and create something from the very scratch.</p>
