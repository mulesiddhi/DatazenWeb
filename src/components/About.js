        ...
        <div className='cards' id='about' >
            ...
            <div className='cards_Container bg-white'>
                <div className='cards_Wrapper bg-white'>
                  ...
                  <p className='bg-white'>DataZen, the official Data Science council of Somaiya Vidyavihar University and we want to help everyone understand and work with data irrespective of their current current knowledge and field. </p>
