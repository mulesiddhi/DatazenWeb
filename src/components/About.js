        ...
        <div className='cards' id='about' >
            ...
            <div className='cards_Container bg-white'>
                <div className='cards_Wrapper bg-white'>
                  ...
                  <p className='bg-white'>We are the official data science council of Somaiya Vidyavihar University and we want to help everyone understand and work with data irrespective of their current knowledge and field. </p>
